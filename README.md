...
Adjust image brightness, contrast, saturation, and gamma with live preview.

## Domain-friendly Name
- Project slug: `tonecraft`
- Suggested domain: `tonecraft.web.app` or `tonecraft.com`
...
- URL: `http://localhost:8111/index.html`
...
3. Initialize project if needed: `firebase use tonecraft-nh2672`
